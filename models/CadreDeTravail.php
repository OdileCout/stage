...
//     }
    ...
    */
    ...
    //    insertion diaporama
    public function inserDiapoCadre($diapo, $donneesDiapo){
        $sql = 'INSERT INTO CadresDeTravail ('.$diapo.') VALUES(:diaporama)'; 
        $pdoStatment = $this->db->prepare($sql); 
        $pdoStatment->bindValue(':diaporama', $donneesDiapo, PDO::PARAM_INT); 
        return $pdoStatment->execute();
    }
   ...
   /**
    ...
    public function miseAjourIcones($idIcone){
        $sql='UPDATE CadresDeTravail
            ...
            WHERE id = :id';
            // UPDATE CadresDeTravail
            // SET  id_IconeDesCadresDeTravail = 48
            // WHERE id = 14
         $pdoStatment = $this->db->prepare($sql); 
...
// fonction qui met en jourleCadre de travail
        ...
        public function miseAjourCadrePourIcones()
        // UPDATE CadresDeTravail SET  id_IconeDesCadresDeTravail = NULL
        // WHERE id_IconeDesCadresDeTravail = 45;
        {
            $query ='UPDATE CadresDeTravail SET  id_IconeDesCadresDeTravail = NULL
