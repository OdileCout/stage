...
<div id="q-app" style="height: auto">
    ...
    <form action="">
        ...
        <div class="q-mb-xl" style="height: auto;">
            <div class="row lesIcones flex flex-center q-mx-md">
                <p class=" col-12 flex flex-center titles">Icônes</p>
                <div class=" col-12 col-md-11">
                    <div class="row" align="center" v-if="cadreselect && edition">
                        <div class="col q-mx-xl q-pb-md" v-for="icon in currentMaxIcones "
                            v-bind:class="{'selected': idIconeChange === icon.id}">
                            <p class="flex flex-center q-pb-sm">{{icon.nom}}</p>
                    ...
                    <div class="row" align="center" v-else>
                        <div class="col q-mx-xl q-pb-md" v-for="icon in currentMaxIcones"
                            v-bind:class="{'selected': idIconeChange === icon.id}">
                            <p class="flex flex-center q-pt-sm">{{icon.nom}}</p>
        ...
        <div class="col-12 col-md-9 q-mx-md">
                                ...
                                <q-input filled v-model="props.row.dateDebut">
                                    ...
                                    <template v-slot:append>
                                        <q-icon name="access_time" class="cursor-pointer">
                                            <q-popup-proxy cover transition-show="scale" transition-hide="scale">
                                                <q-time v-model="props.row.dateDebut" mask="YYYY-MM-DD HH:mm" format24h>
                                                    <div class="row items-center justify-end">
                                                        <q-btn v-close-popup label="Close" color="primary" flat>
                                                        </q-btn>
                                                    </div>
                            ...
                            <q-td key="Date FV" :props="props">
                                <q-input filled v-model="props.row.dateFin" :props="props">
                                    ...
                                    <template v-slot:append>
                                        <q-icon name="access_time" class="cursor-pointer">
                                            <q-popup-proxy cover transition-show="scale" transition-hide="scale">
                                                <q-time v-model="props.row.dateFin" mask="YYYY-MM-DD HH:mm" format24h>
                                                    <div class="row items-center justify-end">
                                                        <q-btn v-close-popup label="Close" color="primary" flat>
                                                        </q-btn>
                                                    </div>
                ...
                <q-card-actions>
                    ...
                    <div class="row col-9 col-md-9 justify-end">
                        ...
                        <div class="row justify-end">
                            <q-btn class="q-ma-xs q-ml-md" round color="red" icon="delete"
                                        ...
                                        <q-tr :props="props">
                                            <q-td key="Nom" :props="props">
                                                <q-input outlined v-model="props.row.nom" type="text"
                                                    @blur="updateNameDoc(props.row.id, props.row.nom)" error-message="">
                                                </q-input>
                                            </q-td>
                                            ...
                                            <q-td key="affecter" :props="props">
                                                <q-checkbox v-model="props.row.affecter" @click="addIdDoc(props.row.id)"
        ...
        <q-dialog v-model="addDoc">
            <q-layout view="Lhh lpR fff" container class="bg-white">
                ...
                <q-page-container>
                    ...
                    <q-card-section>
                        <div style="min-height:25vh;">
                            <div>
                                <q-fab v-model="fab2" label="Choissez le type de document" vertical-actions-align="left"
                                    color="primary" icon="keyboard_arrow_down" direction="down"
                                    @click="changeValueFab = ! changeValueFab">
                                    <div class=" flex flex-row un">
                                        <p class="row q-pa-md q-gutter-md un-un" @click="typeDoc('documents')">
                                    ...
                                    <div class="flex flex-column deux">
                                        <p class="row q-pa-md q-gutter-md deux-deux" @click="typeDoc('video')">
                                            <q-btn round color="brown-5" icon="video_library"></q-btn>
                                            <input outlined type="url" v-if="inputType == 'video'"
                                                v-model="searchVideokey" placeholder="Entrez l'url de la vidéo"></input>
                                        </p>
                                    </div>
                                    <div class=" flex flex-row trois">
                                        <p class="row q-pa-md q-gutter-md trois-trois" @click="typeDoc('image')">
                                            <q-btn round color="black" icon="image"></q-btn>
                                            <input multiple filled type="file" id="UneImage" v-if="inputType == 'image'"
                                                multiple filled type="file">
                                            </input>
                                        </p>
                                    </div>
                                </q-fab>
                ...
                <q-page-container>
                    <q-page padding>
                        <q-card-actions align="right">
                            <q-btn flat label="Enregistrer" @click="insertEtAfficher" color="primary" v-close-popup>
                            </q-btn>
                        </q-card-actions>
                    </q-page>
                </q-page-container>
                    ...
                    <q-card-actions align="right">
                        <div v-if="idIconeChange" class="sepader">
                            <div class="row q-pa-md q-gutter-sm">
                                <q-btn flat label="Supprimer" @click="deleteRefraich" color="white" class="bg-blue"
                                    v-close-popup>
                                </q-btn>
                        ...
                        <div v-else>
                            <q-btn flat label="retour pour selectionnner" color="white" class="bg-blue" v-close-popup>
                            </q-btn>
                        </div>
                    </q-card-actions>
                    <q-separator> </q-separator>
...
?>
<script src="assets/js/scriptnat.js"></script>
</body>
