    ...
    <form action="">
        <div class="row" style="height: auto;">
                ...
                <div class="cadre_travail" style="padding: 0 15px 5px 15px; height: 99%">
                    ...
                    <div>
                        ...
                        <div class="labelDescription">
                            ...
                            <div class='row'>
                                <div v-if="cadreselect" class="col">
            ...
            <div class="mot-cle col-12 col-md-5" style="padding: 0 15px 15px 15px">
                <div class="ligneMotCle_Cdt" style="padding: 0 15px 10px 15px">
                    ...
                    <div v-if="cadreselect && (docNameIdMotCle.length !== 0)">
        ...
        <div class="row" style="height: auto;">
            <div class="col-12 col-md-8 q-pa-md">
                <div class="" v-if="cadreselect && (listeDocumentCadreAttach.length !== 0)">
                    <q-table :columns="columnsDoc" :rows="listeDocumentCadreAttach">
                        <template v-slot:body="props">
                            <q-tr :props="props">
                                <q-td key="Nom" :props="props">
                                    {{ props.row.nom }}
                                ...
                                <q-td key="raffraichir">
                                    <div v-if="props.row.raffraichissement">
                                        <q-input v-model="props.row.raffraichissement" :props="props" filled>
                                        </q-input>
                                    </div>
                                    <div v-else>
                                        <q-input v-model="props.row.raffraichissement" :props="props" filled
                                ...
                                <q-td key="Prioryte">
                                    <q-input min="0"
                                        v-model="props.row.ordreDePriorite" :props="props"
                                        :props="props"></q-input>
                                </q-td>
                ...
                <div class="" v-else-if="keysDocsSelect && (listeDocumentCadreAttach.length == 0) && keysDocsSelect">
                    <q-table :columns="columnsDoc" :rows="keysDocsSelect">
                        <template v-slot:body="props">
                            <q-tr :props="props">
                                ...
                                <q-td key="affecterDoc" :props="props">
                                    <q-checkbox v-model="props.row.affecterDoc"
                                        @click="insertDocSurCadre(cadreselect.value.id,props.row.id,props.row.raffraichissement,props.row.ordreDePriorite)">
                                    </q-checkbox>
                                </q-td>
                            </q-tr>
                        </template>
                                    ...
                                    <q-table :rows="filteredDocs" :columns="columnss" :loading="loading"
                                        ...
                                        <template v-slot:body="props">
                                            <q-tr :props="props">
                                                ...
                                                <q-td key="DuréeAffichage" :props="props">
                                                    <q-input outlined v-model="props.row.dureeAffichage"
                                                        placeholder="changer la valeur"
                                                        @blur="updateDureeAffichDoc(props.row.id, props.row.dureeAffichage)">
                                                    </q-input>
                                                </q-td>
                                                <q-td key="Date DV" :props="props">
                                                    <q-input outlined v-model="props.row.dateDebut"
                                                        @blur="updateDateDvDoc(props.row.id, props.row.dateDebut)"
                                                        class="text-center"></q-input>
                                                </q-td>
                                                <q-td key="Date FV" :props="props">
                                                    <q-input outlined v-model="props.row.dateFin"
                                                        placeholder="changer la valeur"
                                                        @blur="updateDateFVDoc(props.row.id, props.row.dateFin)"
                                                        class="text-center"></q-input>
                                                </q-td>
                ...
                <q-layout view="Lhh lpR fff" container class="bg-white">
                    ...
                    <q-page-container>
                        ...
                        <q-page padding>
                            ...
                            <q-card-section>
                                <input id="UnDocument"
                                    multiple filled type="file" hint=""></input>
                            </q-card-section>
                            <q-card-section>
            ...
            <div class="col-12 col-md-4 q-pa-md" style="height: auto;">
                <div class="row lesIcones" style="border:1px solid Black;">
                    ...
                    <div class="q-pa-md col-12 col-md-10">
                        <div class="row" v-if="cadreselect">
                            <div class="text-blue  col-6 col-md-4" v-for="icon in currentMaxIcones "
                                v-bind:class="{'selected': currentIcone === icon.id}">
                                <p>{{icon.nom}}</p>
                ...
                <div class="q-pa-md">
                    <q-dialog v-model="Iconedialog">
                        <q-card>
                            ...
                            <q-card-actions align="right">
                                <div v-if="currentIcone" class="sepader">
