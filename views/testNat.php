    ...
    <form action="">
        ...
        <div class="row" style="height: auto;">
            <div class="col-12 col-md-8 q-pa-md">
                ...
                <div class=""
                    v-else-if="keysDocsSelect && cadreselect && edition && (listeDocumentCadreAttach.length == 0)">
                                    ...
                                    <div>
                                        <div class="flex flex-column">
                                            <p class="row q-pa-md q-gutter-md" v-on:click="searchInput('name')">
                                                ...
                                                <q-input multiple filled type="file" v-if="inputType == 'name'"
                                                    v-model="searchkey">
                                                </q-input>
                                            </p>
                                        </div>
                                        <div class="flex flex-column">
                                            <p class="row q-pa-md q-gutter-md" v-on:click="searchVideoInput('video')">
                                                ...
                                                <q-input outlined type="url" v-if="inputType == 'video'"
                                                    v-model="searchVideokey" label="Entrez votre url"></q-input>
                                            </p>
                                        </div>
                                        <div class=" flex flex-column">
                                            <p class="row q-pa-md q-gutter-md" v-on:click="searchImageInput('image')">
                                                <q-btn round color="black" icon="image"></q-btn>
                                                <q-input multiple filled type="file" v-if="inputType == 'image'"
                                                    multiple filled type="file" v-model="searchImagekey">
                                                </q-input>
                                            </p>
                                        </div>
                                    </div>
                ...
                <div class="q-pa-md">
                    <q-dialog v-model="validateDialog" persistent>
                        <q-card>
                            ...
                            <q-card-actions align="right">
                                <q-btn flat label="Annuler" color="primary" v-close-popup></q-btn>
                                <q-btn flat label="Supprimer" @click="DeletedDocs(validateDialog.value)"
                                    :disable="!cancelEnabled" color="primary" v-close-popup="cancelEnabled"></q-btn>
                            </q-card-actions>
                        </q-card>
                    </q-dialog>
                </div>
